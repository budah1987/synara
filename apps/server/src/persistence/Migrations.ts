...
import Migration0070 from "./Migrations/070_WorktreeWorkspaces.ts";
import Migration0071 from "./Migrations/071_ProjectionProjectsGitHubAccount.ts";
...
export const migrationEntries = [
  ...
  [70, "WorktreeWorkspaces", Migration0070],
  [71, "ProjectionProjectsGitHubAccount", Migration0071],
] as const;
