...
export const WorktreeWorkspaceId = makeEntityId("WorktreeWorkspaceId");
export type WorktreeWorkspaceId = typeof WorktreeWorkspaceId.Type;
export const WorkspaceOperationId = makeEntityId("WorkspaceOperationId");
